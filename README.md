...
[
  {
    "id": "stu_1",
    "full_name": "Иванов Иван Иванович (FynjyBath, inf:878047)",
    "accounts": [
      {"site": "informatics", "account_id": "878047"},
      {"site": "codeforces", "account_id": "FynjyBath"}
    ]
  }
]
```

### `data/sites/informatics_credentials.json`

```json
{
  "username": "informaticsstudentmsk",
  "password": "Ln5)i-i4/+S*g8Z",
...
Для получения статусов с Codeforces, Informatics и ACMP нужен доступ в интернет.
Для Informatics также нужен файл с логином/паролем (`data/sites/informatics_credentials.json`).
...
- `codeforces` использует реальный API `user.status` по `https://codeforces.com/apiHelp`.
