...
//   - «взял / не взял» среди пробовавших   → идейность задачи;
//   - число посылок до зачёта              → сложность реализации;
...
//
// Смешивание идёт в РОДНЫХ шкалах: оценка хранится как «доля придумавших» и
// «число посылок у придумавшего», а Threshold()/Cost() переводят их ровно в те
// же единицы, в которых
