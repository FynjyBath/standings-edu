...
Для получения статусов с Codeforces нужен доступ в интернет.
...
Примечание:
- `informatics` сейчас stub;
- `codeforces` уже ходит в реальный API `user.status` по `https://codeforces.com/apiHelp`.
